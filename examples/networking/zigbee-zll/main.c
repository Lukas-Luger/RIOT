...
static const shell_command_t shell_commands[] = {
    ...
    { "zigp",         "input a zigbee packet like 030806ffffffff07",        zb_input_packet},
    { "inj",          "inject a raw 802.15.4 packet like 030885ffffffff07 ",zb_inject_packet},
    { "zcl_toggle",   "sending zcl command on",                             zcl_toggle},
    { "tl_scan",      "touchlink channel scan, does not care about reply",  tl_scan},
    { "set_ch",       "set channel to tune into",                           set_channel},
    {NULL,NULL,NULL}
};
